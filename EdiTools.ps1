...
[cmdletbinding()]
    ...
    Process { 
        ...
        #if ($a -is [System.Management.Automation.PSCustomObject]) {Write-Host "psobject"}
...
cls
Select-String -Path 'C:\Users\Lance\Desktop\WORKING FOLDER\EDI\*.*' -Pattern "TRN\*1\*" |Test-Pipeline |gm
